...
public class MascotaRepositorio {
    ...
    public MascotaRepositorio(Connection connection) throws SQLException {
        ...
        consulta.execute("CREATE TABLE IF NOT EXISTS mascota (identificador INTEGER PRIMARY KEY AUTOINCREMENT, nombre TEXT, nacimiento DATE, estado INTEGER, idraza INTEGER, idgrupo INTEGER, FOREIGN KEY(idraza) REFERENCES raza(identificador), FOREIGN KEY(idgrupo) REFERENCES grupofamiliar(identificador))");
        consulta.close();
    }
    ...
    public void crear(String nombre, Date nacimiento, int idraza, int idgrupo) throws SQLException {
        var consulta = conexion.prepareStatement("INSERT INTO mascota (identificador, nombre, nacimiento, idraza, idgrupo) VALUES (?, ?, ?, ?, ?)");
    ...
    public void modificar(Mascota mascota) throws SQLException, GuardiaNoEncontradaExcepcion {
    ...
    public void borrar(Mascota mascota) throws SQLException, GuardiaNoEncontradaExcepcion {
